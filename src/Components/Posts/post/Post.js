...
import { deletePost, getPosts } from '../../../actions/getPosts';
const Post = (props) => {
    ...
    return (
        <Card className={classes.card} >
           ...
           <div className={classes.overlay}>
               <Typography>{props.post.creator}</Typography>
           </div>
           ...
           <div className={classes.details}>
               <Typography variant='body2'>{props.post.tags.map((tag)=>{return tag})}</Typography>
           </div>
           <CardContent>
